...
namespace Lua
{
    public static class Program
    {
        ...
        {
            ProcessAllPloopClassAutoRequire();
            return default;
        ...
        private static List<string> postcopyfiles = new List<string>()
        {
         ...
         private static void ProcessAllPloopClassAutoRequire()
        {
            var topLuaDir = Const.fromTopLuaDir;
            ...
            //处理game.lua
            // 
            luaFile =Path.Combine(Const.fromTopLuaDir,"Common/Logic","Game.lua");
            luaContent = File.ReadAllText(luaFile);
